...
[![Release](https://img.shields.io/github/v/release/OceansCreative/claude-code-c-suite-agents)](https://github.com/OceansCreative/claude-code-c-suite-agents/releases)
[![Lint](https://github.com/OceansCreative/claude-code-c-suite-agents/actions/workflows/lint.yml/badge.svg)](https://github.com/OceansCreative/claude-code-c-suite-agents/actions/workflows/lint.yml)
[![GitHub stars](https://img.shields.io/github/stars/OceansCreative/claude-code-c-suite-agents?style=social)](https://github.com/OceansCreative/claude-code-c-suite-agents/stargazers)
...
自由に fork ・改変・商用利用してください。改善案やプルリクエスト歓迎です（[CONTRIBUTING.md](./CONTRIBUTING.md) / [CODE_OF_CONDUCT.md](./CODE_OF_CONDUCT.md) を参照）。
...
MIT — free to fork, modify, and use commercially. PRs and improvement suggestions welcome (see [CONTRIBUTING.md](./CONTRIBUTING.md) / [CODE_OF_CONDUCT.md](./CODE_OF_CONDUCT.md)).
